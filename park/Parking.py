...
class Parking:
    ...
    def select_rgb_white_yellow(self, image):
        ...
        # lower_red 和高于 upper_red 的部分分别变成 0，lower_red～upper_red 之间的值变成 255，相当于过滤背景
    ...
    def hough_lines(self, image):
        # 输入的图像需要是边缘检测后的结果
        # minLineLengh（线的最短长度，比这个短的都被忽略）和 MaxLineCap（两条直线之间的最大间隔，小于此值，认为是一条直线）
        # rho 距离精度，theta 角度精度，threshod 超过设定阈值才被检测出线段
